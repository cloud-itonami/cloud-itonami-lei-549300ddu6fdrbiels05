(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Fox Corporation, LEI
  549300DDU6FDRBIELS05) -- unlike `commitledger.store`'s multi-application
...
(defn demo-company []
  {:legal-name "Fox Corporation"
   :website    "https://www.fox.com"})

(def ^:private demo-full-text
  "Terms of Use\nThese Terms of Use govern your access to and use of Fox Corporation websites and services. By using this site you agree to these Terms, which are subject to change without notice. This agreement is governed by the laws of the State of Delaware.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.fox.com/terms-of-use"
