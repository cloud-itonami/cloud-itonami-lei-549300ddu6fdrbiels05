...
This repository archives the publicly published Terms of Use of Fox
Corporation, per ADR-2607110300 -- a read-only reference archive. As part
of a 10-repo validation batch extending the
...
- **Company**: Fox Corporation, LEI 549300DDU6FDRBIELS05, website
  `https://www.fox.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.fox.com/terms-of-use`,
